...
| ---------- | ---------------------------------- | --------------------- | ----------------------------------------- | -------- |
| Panel      | `fm_teleop_panel`                  | browser + keyboard    | arm_twist, arm_joint, base_twist, hand_preset, hand_sliders | working  |
...
(no empty packages until then): **phone AR** (ARKit/ARCore pose),
